...
- `docs/` — 9 file markdown mô tả triết lý, thiết kế, framework (tiếng Việt):
  - 01: Triết lý & CriterionTree (mô hình file/folder, so sánh OKR/BSC)
  - 02: CriterionTree & Versioning (lifecycle draft→active→archived, clone từ preset)
  - 03: Sự vụ & ghi nhận (5 category, severity light/normal/heavy, criterion_node_id)
  - 04: Ghi nhận Công việc — WorkLog & Leaf Nodes (external_ref, normalize score, DLQ, điểm công)
  ...
  - 08: CriterionTree Examples — 30 template mẫu (10 phòng × NV/QL/Team)
  - 09: Hiệu chuẩn — calibration period, distribution analysis, thuật toán 3 kỳ, CalibrationProposal
